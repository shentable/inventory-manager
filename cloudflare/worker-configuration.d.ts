/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc cloudflare/worker-configuration.d.ts` (hash: 9b11c10fde9e4db917cbf79474896251)
// Runtime types generated with workerd@1.20260831.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	APP_VERSION: "1.0.0-cloudflare";
	STORE_TIMEZONE: "+08:00";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_VERSION" | "STORE_TIMEZONE" | "ALLOWED_ORIGIN" | "MIGRATION_READ_ONLY" | "TOKEN_SECRET" | "BOOTSTRAP_ADMIN_PIN">> {}
}
